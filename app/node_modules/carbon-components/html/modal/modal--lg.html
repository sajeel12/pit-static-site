...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sp9olqyxfk">Show
  modal</button>

<div data-modal id="modal-sp9olqyxfk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sp9olqyxfk-label" aria-describedby="modal-sp9olqyxfk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sp9olqyxfk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sp9olqyxfk-heading">Modal heading</p>
