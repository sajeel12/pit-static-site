...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qgxfzotmdr">Show
  modal</button>

<div data-modal id="modal-qgxfzotmdr" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qgxfzotmdr-label" aria-describedby="modal-qgxfzotmdr-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qgxfzotmdr-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qgxfzotmdr-heading">Modal heading</p>
