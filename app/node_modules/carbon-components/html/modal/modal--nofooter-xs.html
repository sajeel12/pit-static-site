...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-af20gkrd1ne">Show
  modal</button>

<div data-modal id="modal-af20gkrd1ne" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-af20gkrd1ne-label" aria-describedby="modal-af20gkrd1ne-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-af20gkrd1ne-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-af20gkrd1ne-heading">Modal heading</p>
