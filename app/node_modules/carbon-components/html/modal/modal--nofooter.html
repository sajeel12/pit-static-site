...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mnvebmh682">Show
  modal</button>

<div data-modal id="modal-mnvebmh682" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-mnvebmh682-label" aria-describedby="modal-mnvebmh682-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-mnvebmh682-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-mnvebmh682-heading">Modal heading</p>
