...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-zd2opu8hjtm">Show
  modal</button>

<div data-modal id="modal-zd2opu8hjtm" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-zd2opu8hjtm-label" aria-describedby="modal-zd2opu8hjtm-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zd2opu8hjtm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zd2opu8hjtm-heading">Modal heading</p>
