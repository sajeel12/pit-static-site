...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-16pxuekpu92">Show
  modal</button>

<div data-modal id="modal-16pxuekpu92" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-16pxuekpu92-label" aria-describedby="modal-16pxuekpu92-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-16pxuekpu92-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-16pxuekpu92-heading">Modal heading</p>
