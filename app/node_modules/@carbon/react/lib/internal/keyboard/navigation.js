...
const require_match = require('./match.js');

//#region src/internal/keyboard/navigation.ts
/**
...
const getNextIndex = (key, index, arrayLength) => {
	if (require_match.match(key, require_keys.ArrowRight)) return (index + 1) % arrayLength;
	if (require_match.match(key, require_keys.ArrowLeft)) return (index + arrayLength - 1) % arrayLength;
};
/**
