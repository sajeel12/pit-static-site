...
const useResizeObserver = ({ ref, onResize }) => {
	const [width, setWidth] = (0, react.useState)(-1);
	const [height, setHeight] = (0, react.useState)(-1);
	const entriesToHandle = (0, react.useRef)(null);
	const cb = (0, react.useRef)(onResize);
	(0, react.useEffect)(() => {
		cb.current = onResize;
	}, [onResize]);
	(0, react.useEffect)(() => {
