...
const useControllableState = ({ defaultValue, name = "custom", onChange, value }) => {
	const [state, internalSetState] = (0, react.useState)(typeof value !== "undefined" ? value : defaultValue);
	const controlled = (0, react.useRef)(null);
