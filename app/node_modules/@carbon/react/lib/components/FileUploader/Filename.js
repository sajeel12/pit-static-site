...
function Filename({ iconDescription = "Uploading file", status = "uploading", invalid, name, tabIndex = 0, ["aria-describedby"]: ariaDescribedBy, ...rest }) {
	...
	switch (status) {
		...
		case "complete": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.CheckmarkFilled, {
			"aria-label": iconDescription,
			className: `${prefix}--file-complete`,
			...rest,
			tabIndex: -1,
			children: iconDescription && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("title", { children: iconDescription })
		});
		default: return null;
	}
}
