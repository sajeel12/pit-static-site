...
const AISkeletonPlaceholder = ({ className, ...other }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_SkeletonPlaceholder.default, {
		className: (0, classnames.default)({
			className,
			[`${require_usePrefix.usePrefix()}--skeleton__placeholder--ai`]: true
		}, className),
		...other
	});
};
AISkeletonPlaceholder.propTypes = { className: prop_types.default.string };
