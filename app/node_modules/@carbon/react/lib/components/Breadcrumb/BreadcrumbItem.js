...
* LICENSE file in the root directory of this source tree.
*/
const BreadcrumbItem = (0, react.forwardRef)((props, ref) => {
	...
	const child = (0, react.isValidElement)(children) ? children : null;
	const childType = child?.type;
	if (child && typeof child.type !== "string" && childType?.displayName?.includes("OverflowMenu")) {
		const horizontalOverflowIcon = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.OverflowMenuHorizontal, { className: `${prefix}--overflow-menu__icon` });
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
			className,
			...rest,
			children: react.default.cloneElement(child, {
	...
	if (typeof children === "string") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
		className,
		ref,
		...rest,
		children: href ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_index.default, {
			href,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
		...
		ref,
		...rest,
		children: child ? (0, react.cloneElement)(child, {
			"aria-current": ariaCurrent,
			className: (0, classnames.default)(`${prefix}--link`, child.props.className)
		}) : children
	});
});
BreadcrumbItem.displayName = "BreadcrumbItem";
BreadcrumbItem.propTypes = {
	"aria-current": prop_types.default.oneOfType([prop_types.default.bool, prop_types.default.oneOf([
		"false",
		"true",
		"page",
		"step",
