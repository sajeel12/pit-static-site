...
* LICENSE file in the root directory of this source tree.
*/
const SelectableTag = (0, react.forwardRef)(({ className, disabled, id, renderIcon, onChange, onClick, selected, size, text, defaultSelected = false, ...other }, forwardRef) => {
	const prefix = require_usePrefix.usePrefix();
	const tagRef = (0, react.useRef)(null);
	const generatedTagId = require_useId.useId();
	const tagId = id ?? `tag-${generatedTagId}`;
	const [selectedTag, setSelectedTag] = require_useControllableState.useControllableState({
		value: selected,
		onChange,
		defaultValue: defaultSelected
	});
	const tagClasses = (0, classnames.default)(`${prefix}--tag--selectable`, className, { [`${prefix}--tag--selectable-selected`]: selectedTag });
	...
	const tooltipClasses = (0, classnames.default)(`${prefix}--icon-tooltip`, `${prefix}--tag-label-tooltip`);
	const combinedRef = require_mergeRefs.mergeRefs(tagRef, forwardRef);
	const handleClick = (e) => {
	...
	if (isEllipsisApplied) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Tooltip.Tooltip, {
		...
		leaveDelayMs: 0,
		onMouseEnter: () => false,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Tag.default, {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Tag.default, {
		"aria-pressed": selectedTag !== false,
		ref: combinedRef,
		size,
		renderIcon,
