...
const OperationalTag = (0, react.forwardRef)(({ className, disabled, id, renderIcon, size, text, type = "gray", ...other }, forwardRef) => {
	const prefix = require_usePrefix.usePrefix();
	const tagRef = (0, react.useRef)(null);
	const generatedTagId = require_useId.useId();
	const tagId = id ?? `tag-${generatedTagId}`;
	const tagClasses = (0, classnames.default)(`${prefix}--tag--operational`, className);
