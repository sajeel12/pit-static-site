...
* LICENSE file in the root directory of this source tree.
*/
const DismissibleTag = (0, react.forwardRef)(({ className, decorator, disabled, id, renderIcon, title = "Dismiss", onClose, slug, size, text, tagTitle, type, dismissTooltipAlignment = "bottom", dismissTooltipLabel = "Dismiss tag", ...other }, forwardRef) => {
	const prefix = require_usePrefix.usePrefix();
	const tagLabelRef = (0, react.useRef)(null);
	const generatedTagId = require_useId.useId();
	const tagId = id ?? `tag-${generatedTagId}`;
	const tagClasses = (0, classnames.default)(`${prefix}--tag--filter`, className);
	...
	const combinedRef = require_mergeRefs.mergeRefs(tagLabelRef, forwardRef);
...
const types = Object.keys(require_Tag.TYPES);
