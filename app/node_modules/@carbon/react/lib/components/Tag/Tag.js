...
const Tag = react.default.forwardRef(({ children, className, decorator, id, type, filter, renderIcon: CustomIconElement, title = "Clear filter", disabled, onClose, size, as: BaseComponent, slug, ...other }, forwardRef) => {
	...
	const ref = require_useMergedRefs.useMergedRefs([forwardRef, tagRef]);
	const generatedTagId = require_useId.useId();
	...
	require_useIsomorphicEffect.default(() => {
		...
		setIsEllipsisApplied(require_isEllipsisActive.isEllipsisActive(newElement));
	}, [prefix, tagRef]);
	...
	const tagClasses = (0, classnames.default)(`${prefix}--tag`, className, {
	...
	const normalizedDecorator = require_utils.isComponentElement(candidate, require_index.AILabel) && !isInteractiveTag ? (0, react.cloneElement)(candidate, {
		size: "sm",
		kind: "inline"
	}) : null;
	if (filter) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(BaseComponent ?? "div", {
		className: tagClasses,
		id: tagId,
		...other,
		children: [
			CustomIconElement && size !== "sm" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: `${prefix}--tag__custom-icon`,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomIconElement, {})
			}) : "",
	...
	const labelClasses = (0, classnames.default)({ [`${prefix}--tag__label`]: !isInteractiveTag });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ComponentTag, {
		ref,
		disabled,
		className: tagClasses,
		id: tagId,
		...
		children: [
			...
			isEllipsisApplied && !isInteractiveTag ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_DefinitionTooltip.DefinitionTooltip, {
				openOnHover: false,
...
Tag.propTypes = {
	...
	filter: require_deprecate.deprecate(prop_types.default.bool, "The `filter` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead."),
	id: prop_types.default.string,
	onClose: require_deprecate.deprecate(prop_types.default.func, "The `onClose` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead."),
	renderIcon: prop_types.default.oneOfType([prop_types.default.func, prop_types.default.object]),
	size: prop_types.default.oneOf(Object.keys(SIZES)),
	...
	title: require_deprecate.deprecate(prop_types.default.string, "The `title` prop has been deprecated and will be removed in the next major version. Use DismissibleTag instead."),
