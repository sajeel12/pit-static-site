...
export declare const DataTable: {
    <RowType, ColTypes extends any[]>(props: DataTableProps<RowType, ColTypes>): ReactElement<unknown, string | import("react").JSXElementConstructor<any>> | null;
    Table: {
        ({ className, children, useZebraStyles, size, isSortable, useStaticWidth, stickyHeader, overflowMenuOnHover, experimentalAutoAlign, ...other }: import("react").PropsWithChildren<import("./Table").TableProps>): import("react/jsx-runtime").JSX.Element;
        propTypes: {
    ...
    TableActionList: (props: import("react").HTMLAttributes<"div">) => React.ReactElement<any>;
    TableBatchAction: {
    ...
    TableCell: import("react").ForwardRefExoticComponent<import("./TableCell").TableCellProps & import("react").RefAttributes<HTMLTableCellElement>>;
    TableContainer: {
    ...
    TableExpandRow: import("react").ForwardRefExoticComponent<import("./TableExpandRow").TableExpandRowProps & import("react").RefAttributes<HTMLTableCellElement>>;
    TableExpandedRow: {
    ...
    TableHead: (props: import("react").HTMLAttributes<"thead">) => React.ReactElement<any>;
    ...
    TableToolbarContent: (props: import("react").HTMLAttributes<"div">) => React.ReactElement<any>;
    TableToolbarSearch: {
