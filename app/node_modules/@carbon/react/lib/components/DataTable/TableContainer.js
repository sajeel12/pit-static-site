...
const require_index = require('../Heading/index.js');
...
const TableContainer = ({ aiEnabled, className, children, decorator, title, description, stickyHeader, useStaticWidth, ...rest }) => {
	const baseId = require_useId.useId("tc");
	const titleId = `${baseId}-title`;
	const descriptionId = `${baseId}-description`;
	const prefix = require_usePrefix.usePrefix();
	const tableContainerClasses = (0, classnames.default)(className, `${prefix}--data-table-container`, {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_TableContext.TableContext.Provider, {
		value,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_index.Section, {
			...rest,
			className: tableContainerClasses,
			children: [(title || description || decorator) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: (0, classnames.default)(`${prefix}--data-table-header`, {
				...
				children: [(title || description) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [title && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_index.Heading, {
