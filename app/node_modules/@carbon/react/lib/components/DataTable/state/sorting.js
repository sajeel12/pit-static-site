...
const require_sortStates = require('./sortStates.js');
...
* LICENSE file in the root directory of this source tree.
*/
const initialSortState = require_sortStates.sortStates.NONE;
/**
...
const getNextSortDirection = (prevHeader, currentHeader, prevState) => {
	if (prevHeader === currentHeader) switch (prevState) {
		case require_sortStates.sortStates.NONE: return require_sortStates.sortStates.ASC;
		case require_sortStates.sortStates.ASC: return require_sortStates.sortStates.DESC;
		case require_sortStates.sortStates.DESC: return require_sortStates.sortStates.NONE;
	}
	return require_sortStates.sortStates.ASC;
};
/**
...
const getSortedState = ({ locale, sortRow }, { rowIds, cellsById, initialRowOrder }, key, sortDirection) => {
	return {
		sortHeaderKey: key,
		sortDirection,
		rowIds: sortDirection !== require_sortStates.sortStates.NONE ? require_sorting.sortRows({
			rowIds,
			cellsById,
			sortDirection,
			key,
