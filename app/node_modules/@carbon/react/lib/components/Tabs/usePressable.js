...
const usePressable = (ref, { onPress, onPressIn, onPressOut, onLongPress, delayLongPressMs = 500 } = {}) => {
	const savedOnPress = (0, react.useRef)(onPress);
	const savedOnPressIn = (0, react.useRef)(onPressIn);
	const savedOnPressOut = (0, react.useRef)(onPressOut);
	const savedOnLongPress = (0, react.useRef)(onLongPress);
	const [pendingLongPress, setPendingLongPress] = (0, react.useState)(false);
	const [longPress, setLongPress] = (0, react.useState)(false);
	const state = (0, react.useRef)({ longPress: false });
	(0, react.useEffect)(() => {
