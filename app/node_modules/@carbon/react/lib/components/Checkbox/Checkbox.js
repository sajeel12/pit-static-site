...
* LICENSE file in the root directory of this source tree.
*/
const Checkbox = react.default.forwardRef(({ className, decorator, helperText, id, labelText, onChange = require_noopFn.noopFn, onClick, indeterminate = false, invalid, invalidText, hideLabel, readOnly, title = "", warn, warnText, slug, ...other }, ref) => {
	...
	const wrapperClasses = (0, classnames.default)(`${prefix}--form-item`, `${prefix}--checkbox-wrapper`, className, {
	...
	const innerLabelClasses = (0, classnames.default)(`${prefix}--checkbox-label-text`, { [`${prefix}--visually-hidden`]: hideLabel });
	const candidate = slug ?? decorator;
	const normalizedDecorator = require_utils.isComponentElement(candidate, require_index.AILabel) ? (0, react.cloneElement)(candidate, { size: candidate.props.kind === "inline" ? "md" : "mini" }) : candidate;
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_Text.Text, {
					...
					children: [labelText, slug ? normalizedDecorator : decorator ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [!readOnly && invalid && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.WarningFilled, { className: `${prefix}--checkbox__invalid-icon` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
