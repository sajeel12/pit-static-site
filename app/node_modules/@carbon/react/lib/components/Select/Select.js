...
* LICENSE file in the root directory of this source tree.
*/
const Select = (0, react.forwardRef)(({ className, decorator, id, inline = false, labelText = "Select", disabled = false, children, noLabel = false, hideLabel = false, invalid = false, invalidText = "", helperText, light = false, readOnly, size, warn = false, warnText, onChange, slug, ...other }, ref) => {
	const prefix = require_usePrefix.usePrefix();
	const { isFluid } = (0, react.useContext)(require_FormContext.FormContext);
	const [isFocused, setIsFocused] = (0, react.useState)(false);
	const validChildren = react.default.Children.toArray(children).filter((child) => react.default.isValidElement(child));
	...
	const [title, setTitle] = (0, react.useState)(other?.title || selectedOption?.props?.text || validChildren[0]?.props?.text || "");
	...
	const selectClasses = (0, classnames.default)({
		[`${prefix}--select`]: true,
	...
	const input = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.ChevronDown, { className: `${prefix}--select__arrow` }),
		normalizedProps.invalid && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.WarningFilled, { className: `${prefix}--select__invalid-icon` }),
		!normalizedProps.invalid && normalizedProps.warn && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_carbon_icons_react.WarningAltFilled, { className: `${prefix}--select__invalid-icon ${prefix}--select__invalid-icon--warning` })
	] });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				!noLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Text.Text, {
					as: "label",
					htmlFor: id,
					className: labelClasses,
					children: labelText
				}),
				inline && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				!inline && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						isFluid && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("hr", { className: `${prefix}--select__divider` }),
...
Select.propTypes = {
	...
	defaultValue: prop_types.default.any,
	...
	light: require_deprecate.deprecate(prop_types.default.bool, "The `light` prop for `Select` is no longer needed and has been deprecated in v11 in favor of the new `Layer` component. It will be moved in the next major release."),
	noLabel: prop_types.default.bool,
