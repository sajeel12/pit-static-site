...
const SelectSkeleton = ({ hideLabel, className, ...rest }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		...rest,
		children: [!hideLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `${prefix}--label ${prefix}--skeleton` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: `${prefix}--select ${prefix}--skeleton`,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: `${prefix}--select-input` })
		})]
	});
};
