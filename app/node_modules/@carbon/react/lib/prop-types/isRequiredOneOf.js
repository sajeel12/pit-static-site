...
const isRequiredOneOf = (propTypes) => {
	...
	const checker = (propType) => (props, propName, componentName, ...rest) => {
		if (process.env.NODE_ENV !== "production" && names.every((name) => typeof props[name] === "undefined")) return /* @__PURE__ */ new Error(`${componentName} requires one of the following props: ${names.join(", ")}`);
