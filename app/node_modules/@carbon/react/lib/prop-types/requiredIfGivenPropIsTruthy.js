...
const requiredIfGivenPropIsTruthy = (name, propType) => {
	return (props, propName, componentName, ...rest) => {
		if (process.env.NODE_ENV !== "production" && props[name] === true && props[propName] === null) return /* @__PURE__ */ new Error(`You must provide a value for \`${propName}\` in \`${componentName}\` if \`${name}\` exists.`);
		return propType(props, propName, componentName, ...rest);
	};
};

//#endregion
exports.requiredIfGivenPropIsTruthy = requiredIfGivenPropIsTruthy;