...
import { ArrowLeft, ArrowRight } from "./keys.js";
...
const getNextIndex = (key, index, arrayLength) => {
	if (match(key, ArrowRight)) return (index + 1) % arrayLength;
	if (match(key, ArrowLeft)) return (index + arrayLength - 1) % arrayLength;
};
/**
