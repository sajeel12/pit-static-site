...
const FloatingMenu = ({ children, flipped, focusTrap, menuDirection = DIRECTION_BOTTOM, menuOffset = {
	...
	*/
	const handleBlur = (event) => {
		...
		if (menuBodyRef.current && startSentinelRef.current && endSentinelRef.current && target instanceof HTMLElement && relatedTarget instanceof HTMLElement) wrapFocus({
	...
	*/
	const handleKeyDown = (event) => {
		if (match(event, Tab) && menuBodyRef.current && event.target instanceof HTMLElement) wrapFocusWithoutSentinels({
	...
	if (typeof document !== "undefined") {
		...
		return ReactDOM.createPortal(/* @__PURE__ */ jsxs("div", {
...
//#endregion
export { DIRECTION_BOTTOM, DIRECTION_TOP, FloatingMenu };