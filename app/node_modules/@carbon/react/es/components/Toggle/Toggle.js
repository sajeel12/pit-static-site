...
function Toggle({ "aria-labelledby": ariaLabelledby, className, defaultToggled = false, disabled = false, hideLabel = false, id, labelA = "Off", labelB = "On", labelText, onClick, onToggle, readOnly, size = "md", toggled, ...other }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("button", {
			...
			disabled,
			onClick: handleClick
		}), /* @__PURE__ */ jsxs(LabelComponent, {
			id: labelId,
			htmlFor: ariaLabelledby ? void 0 : id,
			className: `${prefix}--toggle__label`,
			children: [labelText && /* @__PURE__ */ jsx(Text, {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: isSm && !readOnly && /* @__PURE__ */ jsx("svg", {
						"aria-hidden": "true",
						focusable: "false",
						...
						height: "5px",
						viewBox: "0 0 6 5",
						children: /* @__PURE__ */ jsx("path", { d: "M2.2 2.7L5 0 6 1 2.2 5 0 2.7 1 1.5z" })
					})
				}), renderSideLabel && /* @__PURE__ */ jsx(Text, {
