...
* LICENSE file in the root directory of this source tree.
*/
const Checkbox$1 = React.forwardRef(({ className, decorator, helperText, id, labelText, onChange = noopFn, onClick, indeterminate = false, invalid, invalidText, hideLabel, readOnly, title = "", warn, warnText, slug, ...other }, ref) => {
	...
	const wrapperClasses = classNames(`${prefix}--form-item`, `${prefix}--checkbox-wrapper`, className, {
		...
		children: [
			...
			/* @__PURE__ */ jsx("label", {
				...
				children: /* @__PURE__ */ jsxs(Text, {
					...
					children: [labelText, slug ? normalizedDecorator : decorator ? /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [!readOnly && invalid && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(WarningFilled, { className: `${prefix}--checkbox__invalid-icon` }), /* @__PURE__ */ jsx("div", {
