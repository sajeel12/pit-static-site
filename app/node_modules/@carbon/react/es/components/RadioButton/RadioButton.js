...
const RadioButton = React.forwardRef((props, ref) => {
	...
	const innerLabelClasses = classNames(`${prefix}--radio-button__label-text`, { [`${prefix}--visually-hidden`]: hideLabel });
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("label", {
				...
				children: [/* @__PURE__ */ jsx("span", { className: `${prefix}--radio-button__appearance` }), labelText && /* @__PURE__ */ jsxs(Text, {
