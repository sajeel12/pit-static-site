...
* LICENSE file in the root directory of this source tree.
*/
const TextInput = forwardRef(({ className, decorator, disabled = false, helperText, hideLabel, id, inline = false, invalid = false, invalidText, labelText, light, onChange = () => {}, onClick = () => {}, placeholder, readOnly, size, type = "text", warn = false, warnText, enableCounter = false, maxCount, slug, ...rest }, ref) => {
	...
	const counter = enableCounter && maxCount ? /* @__PURE__ */ jsx(Text, {
		as: "div",
	...
	const labelWrapper = /* @__PURE__ */ jsxs("div", {
	...
	const input = /* @__PURE__ */ jsx("input", { ...getTextInputProps({
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!inline ? labelWrapper : /* @__PURE__ */ jsxs("div", {
