...
const getButtonKind = (element) => {
	if (React.isValidElement(element) && element.props && typeof element.props === "object") return element.props.kind ?? "primary";
	return "primary";
};
const ButtonSet = forwardRef((props, ref) => {
	...
	*/
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: fluid ? /* @__PURE__ */ jsx("div", {
			ref: fluidInnerRef,
			className: classNames(`${prefix}--btn-set__fluid-inner`, { [`${prefix}--btn-set__fluid-inner--auto-stack`]: true }),
