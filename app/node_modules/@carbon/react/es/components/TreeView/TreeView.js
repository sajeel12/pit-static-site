...
import { ArrowDown, ArrowUp, End, Home } from "../../internal/keyboard/keys.js";
...
const TreeView = ({ active: prespecifiedActive, children, className, hideLabel = false, label, multiselect = false, onActivate, onSelect, selected: preselected, size = "sm", ...rest }) => {
	...
	const treeClasses = classNames(className, `${prefix}--tree`, { [`${prefix}--tree--${size}`]: size !== "default" });
	...
	function handleKeyDown(event) {
		...
		if (match(event, ArrowUp)) nextFocusNode = treeWalker.current.previousNode();
		if (match(event, ArrowDown)) nextFocusNode = treeWalker.current.nextNode();
		if (matches(event, [
			Home,
			End,
			{ code: "KeyA" }
	...
	const TreeLabel = () => !hideLabel ? /* @__PURE__ */ jsx("label", {
		id: labelId,
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TreeLabel, {}), /* @__PURE__ */ jsx(TreeContext.Provider, {
