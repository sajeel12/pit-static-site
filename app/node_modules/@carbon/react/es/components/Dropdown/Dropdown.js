...
* LICENSE file in the root directory of this source tree.
*/
const { ItemMouseMove, MenuMouseLeave, ToggleButtonBlur, FunctionCloseMenu } = useSelect.stateChangeTypes;
/**
...
const Dropdown = React.forwardRef(({ autoAlign = false, className: containerClassName, decorator, disabled = false, direction = "bottom", items: itemsProp, label, ["aria-label"]: ariaLabel, ariaLabel: deprecatedAriaLabel, itemToString = defaultItemToString, itemToElement = null, renderSelectedItem, type = "default", size: size$1, onChange, id, titleText = "", hideLabel, helperText = "", translateWithId, light, invalid, invalidText, warn, warnText, initialSelectedItem, selectedItem: controlledSelectedItem, downshiftProps, readOnly, slug, ...other }, ref) => {
	...
	const { isOpen, getToggleButtonProps, getLabelProps, getMenuProps, getItemProps, selectedItem, highlightedIndex } = useSelect(selectProps);
	...
	const helper = helperText && !isFluid ? /* @__PURE__ */ jsx("div", {
	...
	const menuProps = useMemo(() => getMenuProps({ ref: enableFloatingStyles || autoAlign ? refs.setFloating : null }), [
		autoAlign,
		getMenuProps,
		refs.setFloating,
			...
			/* @__PURE__ */ jsxs(ListBox, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("button", {
						...
						title: selectedItem && itemToString !== void 0 ? itemToString(selectedItem) : defaultItemToString(label),
						...toggleButtonProps,
					...
					/* @__PURE__ */ jsx(ListBox.Menu, {
						...
						children: isOpen && items.map((item, index) => {
							...
							return /* @__PURE__ */ jsxs(ListBox.MenuItem, {
								...
								...itemProps,
								children: [itemToElement ? itemToElement(item) : itemToString(item), selectedItem === item && /* @__PURE__ */ jsx(Checkmark, { className: `${prefix}--list-box__menu-item__selected-icon` })]
							}, itemProps.id);
						})
					})
				]
