...
const ContainedListItem = ({ action, children, className, disabled = false, onClick, renderIcon: IconElement, ...rest }) => {
	...
	const content = /* @__PURE__ */ jsxs(Fragment, { children: [IconElement && /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("li", {
		className: classes,
		...rest,
		children: [isClickable ? /* @__PURE__ */ jsx("button", {
			...
			className: `${prefix}--contained-list-item__content`,
			children: content
		}), action && /* @__PURE__ */ jsx(LayoutConstraint, {
			size: {
				min: "sm",
				max: "lg"
			},
