...
// Floating Orb Component - Warm/Orange theme
...
// Particle Field Component - Warm ember particles
const ParticleField = () => {
...
const Scene = () => {
  ...
  return (
    <group ref={groupRef}>
      {/* Floating Orbs - Warm/Orange theme */}
      <FloatingOrb
        position={[4, 1, -2]}
        color="#f97316"
        size={1.2}
