      ...
      <section id="overview" className="relative pt-40 pb-20 bg-[#0a1628] overflow-hidden">
        ...
        <div className="relative z-10 cds--css-grid" style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
          ...
          <nav className="relative z-10 flex items-center gap-2 text-xs mb-6" aria-label="Breadcrumb">
            ...
            <ChevronRight className="w-3 h-3 text-gray-400" />
            <a href="/services/platforms" className="text-[#24a148] hover:underline">IT Platforms</a>
            <ChevronRight className="w-3 h-3 text-gray-400" />
            <span className="text-gray-400">Service Desk</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div>
              {/* Eyebrow Label */}
              <span className="inline-block carbon-label-01 text-[#24a148] uppercase tracking-wider mb-3">
                ITSM & SUPPORT
              </span>
              ...
              {/* Subtitle */}
              <p className="carton-body-01 text-[#24a148] font-semibold mb-4">
              ...
              <p className="carbon-body-02 text-gray-300 mb-6">
                ...
                From ticket management to self-service portals, we deliver measurable improvements 
                in user satisfaction while reducing operational costs by up to 60%.
              </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-4 p-4 border-l-2 border-[#24a148] bg-white/5">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">Intelligent Ticket Management</h3>
              ...
              <div className="flex items-start gap-4 p-4 border-l-2 border-[#24a148] bg-white/5">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">Self-Service Portal</h3>
              ...
              <div className="flex items-start gap-4 p-4 border-l-2 border-[#24a148] bg-white/5">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">Knowledge Base</h3>
              ...
              <div className="flex items-start gap-4 p-4 border-l-2 border-[#24a148] bg-white/5">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">Intelligent Automation</h3>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm transition-colors border-l-[3px] ${
                          activeSection === item.id
                            ? 'text-gray-900 border-[#24a148] bg-green-50 carbon-label-01 font-semibold'
