...
export const PROJECTS = [
  ...
  { title: 'Hardware Maintenance', sector: 'University / Education', org: 'LUMS', desc: 'Deployed precision cooling units across four data centres, reducing PUE from 1.8 to 1.35.', outcomes: ['PUE reduced from 1.8 to 1.35','N+1 redundancy achieved','8-week deployment timeline'], tags: ['Multi-Site','PUE Optimisation','N+1 Redundancy'], link: '/case-studies/multi-site-precision-cooling', image: '/Sections/Cooling page/Images-cooling/Case studies/LUMS/LUMS-1-1600×700.webp' },



  { title: 'Thermal Runaway Prevention', sector: 'Engineering / Procurement / Construction (EPC)', org: 'Leading Multinational Conglomerate', desc: 'Redesigned airflow management preventing thermal runaway and extending equipment lifespan.', outcomes: ['Hotspots eliminated','3°C average temperature reduction','Annual cooling cost savings of 25%'], tags: ['Airflow Redesign','Thermal Mapping','Cost Reduction'], link: '/case-studies/thermal-runaway-prevention', image: '/Sections/Cooling page/Images-cooling/Case studies/descon/DESCON11600×700.webp' },



  { title: 'Monsoon Season Resilience', sector: 'FMCG', org: 'Confectionery & Bakery Manufacturing', desc: 'Implemented humidity control and drainage systems to maintain operations during monsoon season.', outcomes: ['Zero humidity-related outages','99.9% uptime maintained','Reduced equipment corrosion by 40%'], tags: ['Humidity Control','Drainage Systems','Monsoon Hardening'], link: '/case-studies/monsoon-season-resilience', image: '/Sections/Cooling page/Images-cooling/Case studies/Mayfair/MAYFAIR1:1600×700.webp' },
