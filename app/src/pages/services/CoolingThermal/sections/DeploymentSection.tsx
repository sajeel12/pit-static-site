        ...
        <div className="p-8 rounded-xl relative overflow-hidden mb-6 bg-gradient-to-r from-[#0f62fe] to-[#4589ff]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 relative text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center w-full sm:w-auto">
              ...
              <a href="mailto:contact@perception-it.com?subject=Deployment%20Consultation%20Request" className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-white text-[#0f62fe] carbon-body-02 hover:bg-gray-50 transition-colors rounded-lg w-full sm:w-auto">Speak to an Engineer</a>
