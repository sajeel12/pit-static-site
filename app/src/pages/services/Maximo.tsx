  ...
  const caseStudies = [
    {
      ...
      stats: [
        { value: '100%', label: 'Data Migration', color: '#0f62fe' },
        ...
        <div className="relative z-10 cds--css-grid" style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
          <div className="cds--col-span-16 lg:cds--col-span-14 lg:cds--col-start-2">
            ...
            <h1 className="carbon-fluid-heading-05 text-white mb-6">
              <span className="block">MAXIMO</span>
              <span className="block text-blue-300">Engineered for Scale, Optimized for Transition</span>
            </h1>

            {/* Value Proposition Block */}
            <div className="max-w-3xl mb-8">
              {/* Lead Statement */}
              <p className="carbon-body-02 text-gray-300 mb-5 leading-relaxed">
                From <strong className="text-white">high-availability database clusters</strong> for massive Telco datasets 
                to seamless migrations to <strong className="text-white">modern ITSM platforms</strong>. 
                We maximize your current Maximo investment or strategically transition you to 
                cloud-native efficiency without losing process continuity.
              </p>
              
              {/* Proof Point */}
              <div className="flex items-center gap-3">
                <span className="cds--tag bg-[#0f62fe]/10 text-[#0f62fe] border border-[#0f62fe]/20 inline-flex flex-shrink-0">
                  <CheckmarkFilled className="w-3 h-3 mr-1" />
                  Zero-Downtime Proven
                </span>
                <span className="text-xs text-gray-400">
                  Delivered in complex data integrity environments requiring absolute precision.
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                { 
                  ...
                  subtext: 'Active-Active Clustering',
                  link: '#technical',
                  clickable: true
                },
                { 
                  icon: Migrate,
                  headline: 'ServiceNow & Cloud-Native Migration Specialists', 
                  subtext: 'Seamless Transition',
                  link: '#migration',
                  clickable: true
                },
                { 
                ...
                { 
                  icon: Box,
                  headline: 'Asset Lifecycle', 
                  subtext: 'End-to-End Management',
                  link: '#solutions',
                  clickable: true
                },
                { 
                ...
                <button
                  ...
                  className="cds--tile bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)] p-4 flex flex-col gap-3 text-left hover:border-[#0f62fe] hover:shadow-sm transition-all cursor-pointer"
                >
                  ...
                  <div className="cds--col-span-16 lg:cds--col-span-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={cap.title} className="group p-5 bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)] hover:border-[#0f62fe] transition-colors">
                          <div className="flex items-start gap-4">
                            <div className="w-12 h-12 bg-[var(--cds-layer-02)] flex items-center justify-center flex-shrink-0">
                              <cap.icon className="w-6 h-6 text-[#0f62fe]" />
                            </div>
                            <div>
                  ...
                  <div className="cds--col-span-16 lg:cds--col-span-12">
                    ...
                    <div className="space-y-4">
                      <div className="p-6 bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)]">
                        <div className="flex items-start gap-4">
                          <div className="w-16 h-16 bg-[#0f62fe]/10 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="p-6 bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)]">
                        <div className="flex items-start gap-4">
                          <div className="w-16 h-16 bg-[#0f62fe]/10 flex items-center justify-center flex-shrink-0">
                            <Plug className="w-8 h-8 text-[#0f62fe]" />
                          </div>
                          <div className="flex-1">
                            <h3 className="carbon-heading-02 text-[var(--cds-text-primary)] mb-2">
                      ...
                      <div className="p-6 bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)]">
                        <div className="flex items-start gap-4">
                          <div className="w-16 h-16 bg-[#0f62fe]/10 flex items-center justify-center flex-shrink-0">
                            <Settings className="w-8 h-8 text-[#0f62fe]" />
                          </div>
                          <div className="flex-1">
                            <h3 className="carbon-heading-02 text-[var(--cds-text-primary)] mb-2">
                ...
                <div className="cds--css-grid">
                  <div className="cds--col-span-16 lg:cds--col-span-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-6 bg-[#0f62fe]/5 border border-[#0f62fe]/20">
                    ...
                    <div className="bg-[var(--cds-layer-01)] border border-[var(--cds-border-subtle)]">
                      {caseStudies[currentCaseStudy].quote ? (
                        ...
                        <div className="grid md:grid-cols-3 gap-6 p-6">
                          ...
                          <div className="bg-[var(--cds-background)] p-4 border-l-4 border-[#0f62fe]">
                ...
                <div className="cds--css-grid">
                  <div className="cds--col-span-16 lg:cds--col-span-12">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 mb-10">
                      {[
                        { step: '01', title: 'Asset Health Audit', desc: 'Identify compliance gaps, warranty risks, and performance bottlenecks.', color: '#0f62fe' },
                    ...
                    <div className="p-8 bg-[#0f62fe] text-center">
                      ...
                      <a 
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#0f62fe] carbon-label-01 hover:bg-[#e5e5e5] transition-colors"
                      >
                        Request Assessment
                        <ArrowRight className="w-4 h-4" />
                      </a>
