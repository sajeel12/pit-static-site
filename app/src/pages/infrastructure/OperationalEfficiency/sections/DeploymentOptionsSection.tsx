...
export default function DeploymentOptionsSection() {
  ...
  const toggleBenefits = (card: string) => {
  ...
  const isOpen = (card: string) => openBenefits.has(card);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="group relative bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
            ...
            <div className="p-6 sm:p-8 flex flex-col flex-1">
              ...
              <div className="mb-6">
                <p className="carbon-fluid-heading-03 text-gray-900 leading-tight">Data Centre Ecosystem Integration</p>
              </div>
              <div className="mb-6 p-5 bg-[#0f62fe]/5 rounded-lg border border-[#0f62fe]/20">
                <p className="carbon-heading-02 text-[#0f62fe] mb-5">Enterprise volume pricing. Unified scope across integrated layers.</p>
              ...
              <div className="mb-6">
                ...
                <ul className="space-y-2 carbon-body-02 text-gray-600">
                  <li className="flex items-start gap-2">
                    <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
              ...
              <div className="pt-6 border-t border-gray-100">
                <button
                  type="button"
                  onClick={() => toggleBenefits('ecosystem')}
                  className="flex items-center justify-between w-full px-3 py-2 rounded-md border border-gray-200 bg-[#f5f8ff] text-gray-500 carbon-label-01 uppercase tracking-wider mb-4 hover:border-[#0f62fe]/30 hover:text-[#0f62fe] hover:bg-[#0f62fe]/10 transition-colors"
                >
                  <span>Key Benefits</span>
                  <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isOpen('ecosystem') ? 'rotate-180' : ''}`} />
                </button>
                {isOpen('ecosystem') && (
          ...
          <div className="group relative bg-white rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
            ...
            <div className="p-6 sm:p-8 flex flex-col flex-1">
              ...
              <div className="mb-6">
                <p className="carbon-fluid-heading-03 text-gray-900 leading-tight">Deploy by Individual Service</p>
              </div>
              <div className="mb-6 p-5 bg-[#0f62fe]/5 rounded-lg border border-[#0f62fe]/20">
                <p className="carbon-heading-02 text-[#0f62fe] mb-5">Fixed scope, fixed price. Pay per layer.</p>
                <ul className="space-y-3 carbon-body-02 text-gray-600">
                  <li className="flex items-start gap-2">
                    <span className="w-1 h-1 rounded-full bg-gray-400 mt-2 flex-shrink-0" />
              ...
              <div className="pt-6 border-t border-gray-100">
                <button
                  type="button"
                  onClick={() => toggleBenefits('individual')}
                  className="flex items-center justify-between w-full px-3 py-2 rounded-md border border-gray-200 bg-[#f5f8ff] text-gray-500 carbon-label-01 uppercase tracking-wider mb-4 hover:border-[#0f62fe]/30 hover:text-[#0f62fe] hover:bg-[#0f62fe]/10 transition-colors"
                >
                  <span>Key Benefits</span>
                  <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isOpen('individual') ? 'rotate-180' : ''}`} />
                </button>
                {isOpen('individual') && (
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
